    ...
    : describe("Nft Marketplace Unit Tests", function () {
          ...
          describe("withdrawProceeds", function () {
              ...
              it("withdraws proceeds", async function () {
                  ...
                  const transacntionReceipt = await txResponse.wait(1)
                  const { gasUsed, effectiveGasPrice } = transacntionReceipt
                  const gasCost = gasUsed.mul(effectiveGasPrice)
                  const deployerBalanceaAfter = await deployer.getBalance()

                  assert(
                      deployerBalanceaAfter.add(gasCost).toString() ==
